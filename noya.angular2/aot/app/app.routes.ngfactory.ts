...
import * as import1 from '../../app/app.routes';
...
import * as import8 from '../../app/common/can-deactivate-guard.service';
import * as import9 from '@angular/core/src/di/injector';
import * as import10 from './Home/home.ngfactory';
import * as import11 from './Biography/biography.ngfactory';
import * as import12 from './Pictures/pictures.ngfactory';
import * as import13 from './Videos/videos.ngfactory';
import * as import14 from './Programs/programs.ngfactory';
import * as import15 from './Links/links.ngfactory';
import * as import16 from './Contact/contact.ngfactory';
...
import * as import20 from '../../app/Home/home';
import * as import21 from '../../app/Biography/biography';
import * as import22 from '../../app/Pictures/pictures';
import * as import23 from '../../app/Videos/videos';
import * as import24 from '../../app/Programs/programs';
import * as import25 from '../../app/Links/links';
import * as import26 from '../../app/Contact/contact';
import * as import27 from '@angular/core/src/application_ref';
import * as import28 from '@angular/router/src/url_handling_strategy';
import * as import29 from '@angular/router/src/route_reuse_strategy';
import * as import30 from '@angular/router/src/router';
import * as import31 from '@angular/core/src/linker/ng_module_factory_loader';
import * as import32 from '@angular/router/src/router_config_loader';
...
class AppRoutingModuleInjector extends import0.NgModuleInjector<import1.AppRoutingModule> {
  ...
  __CanDeactivateGuard_19:import8.CanDeactivateGuard;
  ...
  get _Router_10():any {
    if ((this.__Router_10 == null)) { (this.__Router_10 = import2.setupRouter(this.parent.get(import27.ApplicationRef),this._UrlSerializer_6,this._RouterOutletMap_7,this._Location_5,this,this._NgModuleFactoryLoader_8,this.parent.get(import19.Compiler),this._ROUTES_9,this._ROUTER_CONFIGURATION_3,this.parent.get(import28.UrlHandlingStrategy,(null as any)),this.parent.get(import29.RouteReuseStrategy,(null as any)))); }
  ...
  get _ROUTER_INITIALIZER_17():any {
    if ((this.__ROUTER_INITIALIZER_17 == null)) { (this.__ROUTER_INITIALIZER_17 = import2.initialRouterNavigation(this._Router_10,this.parent.get(import27.ApplicationRef),this._RouterPreloader_14,this._ROUTER_CONFIGURATION_3)); }
  ...
  get _CanDeactivateGuard_19():import8.CanDeactivateGuard {
    if ((this.__CanDeactivateGuard_19 == null)) { (this.__CanDeactivateGuard_19 = new import8.CanDeactivateGuard()); }
    return this.__CanDeactivateGuard_19;
  }
  createInternal():import1.AppRoutingModule {
    this._ROUTER_FORROOT_GUARD_0 = import2.provideForRootGuard(this.parent.get(import30.Router,(null as any)));
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import31.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_8; }
    if ((token === import32.ROUTES)) { return this._ROUTES_9; }
    if ((token === import30.Router)) { return this._Router_10; }
    if ((token === import33.ActivatedRoute)) { return this._ActivatedRoute_11; }
    ...
    if ((token === import27.NgProbeToken)) { return this._NgProbeToken_16; }
    if ((token === import2.ROUTER_INITIALIZER)) { return this._ROUTER_INITIALIZER_17; }
    if ((token === import34.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_18; }
    if ((token === import8.CanDeactivateGuard)) { return this._CanDeactivateGuard_19; }
