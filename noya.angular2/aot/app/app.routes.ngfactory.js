...
var AppRoutingModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppRoutingModuleInjector.prototype, "_ROUTER_INITIALIZER_17", {
        get: function () {
            if ((this.__ROUTER_INITIALIZER_17 == null)) {
                (this.__ROUTER_INITIALIZER_17 = import2.initialRouterNavigation(this._Router_10, this.parent.get(import27.ApplicationRef), this._RouterPreloader_14, this._ROUTER_CONFIGURATION_3));
            }
    ...
    Object.defineProperty(AppRoutingModuleInjector.prototype, "_CanDeactivateGuard_19", {
        get: function () {
            if ((this.__CanDeactivateGuard_19 == null)) {
                (this.__CanDeactivateGuard_19 = new import8.CanDeactivateGuard());
            }
            return this.__CanDeactivateGuard_19;
        },
        enumerable: true,
        configurable: true
    });
    ...
    AppRoutingModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import34.APP_BOOTSTRAP_LISTENER)) {
            return this._APP_BOOTSTRAP_LISTENER_18;
        }
        if ((token === import8.CanDeactivateGuard)) {
            return this._CanDeactivateGuard_19;
        }
